...
function Profile() {
  ...
  useEffect(() => {
    ...
    async function likedRecipe() {
      let response = await axios.get("http://localhost:3333/healthyfy/userLikes", {
        withCredentials: true,
      });
      let data = response.data;
